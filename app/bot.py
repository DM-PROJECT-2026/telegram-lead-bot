...
from app.handlers import NAME, PHONE, COUNTRY, COMMENT, CONFIRMATION, start, name, phone, country, comment, confirm, restart, cancel, privacy, show_recent_leads, show_stats, unexpected
